...
INSERT INTO Pacotes (NomePacote, Descricao, DataIda, DataVolta, Valor, IdCidade, Ativo) VALUES  ('SALVADOR - 5 DIAS / 4 DIÁRIAS', '- O que não falta em Salvador são atrações. 
Prova disso são as praias, os
...
estrangeiros. O Pelourinho e o Elevador são alguns dos principais pontos de visitação.', '06/08/2020', '10/08/2020', 854.00, 1, 1), 
('- RESORTS NA BAHIA - LITORAL NORTE - 5 DIAS / 4 DIÁRIAS', ' caminhada pela orla e calçadões,
...
região.', '28/03/2020', '01/04/2020', 1004.00, 2, 1)